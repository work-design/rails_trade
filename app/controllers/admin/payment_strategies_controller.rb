class Admin::PaymentStrategiesController < Admin::TheTradeController
  ...
  def create
    ...
    if @payment_strategy.save
      redirect_to @payment_strategy, notice: 'Payment strategy was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @payment_strategy.update(payment_strategy_params)
      redirect_to @payment_strategy, notice: 'Payment strategy was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to payment_strategies_url, notice: 'Payment strategy was successfully destroyed.'
  end
