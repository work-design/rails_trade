module Trade
  class OrdersController < My::OrdersController
    ...
    def qrcode
      ...
      elsif current_user.members.pluck(:organ_id).include? @order.organ&.provider_id
        redirect_to({ controller: 'trade/partner/orders', action: 'show', id: @order.id, host: @order.organ.provider.admin_host }, allow_other_host: true)
