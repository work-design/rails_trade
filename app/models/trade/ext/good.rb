module Trade
  module Ext::Good
    ...
    included do
      ...
      has_many :available_promote_goods, ->(o) { effective.where(good_id: [o.id, nil]) }, class_name: 'Trade::PromoteGood', primary_key: :good_type, foreign_key: :good_type
      ...
      has_many :wallet_goods, class_name: 'Trade::WalletGood', primary_key: :good_type, foreign_key: :good_type
    ...
    def set_wallet_price!(wallet_good)
      self.wallet_price.merge! wallet_good.wallet_code => price * wallet_good.ratio
      self.save
    end
