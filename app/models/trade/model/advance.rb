module Trade
  module Model::Advance
    ...
    included do
      ...
      validates :amount, uniqueness: { scope: [:organ_id, :wallet_template_id, :card_template_id, :open] }
      validates :price, uniqueness: { scope: [:organ_id, :wallet_template_id, :card_template_id, :open] }
