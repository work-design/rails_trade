...
module Trade
  module Model::Cart
    ...
    def get_trade_item(good_type, good_id, number = 1, produce_plan_id = nil)
      trade_item = trade_items.find(&->(i){ i.good_type == good_type && i.good_id.to_s == good_id.to_s && i.produce_plan_id.to_s == produce_plan_id.to_s }) || trade_items.build(good_id: good_id, good_type: good_type, produce_plan_id: produce_plan_id)
