...
module Trade
  module Model::Cart
    ...
    included do
      ...
      has_many :checked_trade_items, ->(o) { where(organ_id: o.organ_id, member_id: o.member_id, status: 'checked') }, class_name: 'TradeItem', foreign_key: :user_id, primary_key: :user_id, dependent: :destroy_async
      has_many :all_trade_items, ->(o) { where(organ_id: o.organ_id, member_id: o.member_id) }, class_name: 'TradeItem', foreign_key: :user_id, primary_key: :user_id, dependent: :destroy_async
