module Trade
  module Model::Payment::WxpayPayment
    ...
    included do
      ...
      belongs_to :wechat_user, class_name: 'Wechat::WechatUser', foreign_key: :buyer_identifier, primary_key: :uid, optional: true
    ...
    def send_verify_notice
      Turbo::StreamsChannel.broadcast_stream_to(
        self,
        content: Turbo::StreamsChannel.turbo_stream_action_tag(:visit, url: Rails.app.routes.url_for(controller: 'trade/my/wxpay_payments', action: 'show', id: self.id))
      )
    end
