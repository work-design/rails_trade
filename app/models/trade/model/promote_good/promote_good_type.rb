module Trade
  module Model::PromoteGood::PromoteGoodType
    ...
    included do
      ...
      belongs_to :master,  ->(o){ where(good_type: o.good_type, good_id: nil, status: 'available') }, class_name: self.name, foreign_key: :promote_id, primary_key: :promote_id, counter_cache: true, optional: true
    end
